...
Esta es una solución del proyecto **Pricing Component with toggle** como parte del reto de codificación #100DaysOfProjects [Front End Club](https://www.facebook.com/frontendclubfb). La mejor manera de escribir un buen código es programando todos los días🔥.
...
![](./screen/mobile-design-monthly.jpg)
...
Usamos `Javascript` para el toggle:
